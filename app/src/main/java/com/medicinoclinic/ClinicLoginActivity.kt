       ...
       /* FirebaseInstanceId.getInstance().instanceId
        ...
        login_status = baseClass.getSharedPreferance(applicationContext,"login_status","false")
            ...
            if(login_status.equals("false")) {
                clinicUserName = baseClass.getSharedPreferance(applicationContext,"clinicUsername","")
...
//                finish()
    ...
    private fun getLogin(userName: String, password: String) {
        ...
        val progressDialog = ProgressDialog(this@ClinicLoginActivity, R.style.MyTheme)
        ...
        mAPIService.login(userName, password,"1", fcm.toString()).enqueue(object : Callback<ResponseBody> {
